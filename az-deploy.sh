...
PLAN_NAME="deutschetelekom-plan"
...
# Create webapp
az webapp create --name $SITE_NAME --resource-group $RESOURCE_GROUP --plan $PLAN_NAME --location $LOCATION --deployment-source-url $GITHUB_REPO --branch "main" --runtime "PHP|$PHP_VERSION"
